...
* **Antivirus:** Some overly aggressive antivirus programs might flag the scraper because it runs in the background and makes rapid web requests. You may need to add it to your antivirus exclusion list if it gets blocked during the building process.
